...
readGriglia(griglia(griglia(player(x(6))))).
readGriglia(griglia(griglia(player(y(11))))).
...
readGriglia(griglia(griglia(mappa(13,cella(val(3)))))).
...
readGriglia(griglia(griglia(mappa(38,cella(val(0)))))).
...
readGriglia(griglia(griglia(mappa(49,cella(val(5)))))).
